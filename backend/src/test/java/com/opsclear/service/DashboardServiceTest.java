...
class DashboardServiceTest {
    ...
    void get_shouldReturnCorrectSummaryCounts_whenProjectHasJobsInVariousStatuses() {
        ...
        when(jobService.list(projectId, ownerId, null)).thenReturn(jobs);
    ...
    void get_shouldReturnBlockedJobs_sortedByBlockedAtAsc() {
        when(jobService.list(projectId, ownerId, null)).thenReturn(List.of(blockedJobNewer, blockedJobOlder));
        when(projectMemberRepository.findByProjectIdAndUserId(projectId, ownerId))
                .thenReturn(Optional.of(ownerMembership));
        when(approvalService.listPendingByProject(projectId, ownerId)).thenReturn(List.of());
        ...
        assertThat(result.getBlockedJobs().get(0).getTitle()).isEqualTo("Blocked Older");
    ...
    void get_shouldReturnOverdueJobs_sortedByDeadlineAsc() {
        when(jobService.list(projectId, ownerId, null)).thenReturn(List.of(overdueJobLater, overdueJobEarlier));
        when(projectMemberRepository.findByProjectIdAndUserId(projectId, ownerId))
                .thenReturn(Optional.of(ownerMembership));
        when(approvalService.listPendingByProject(projectId, ownerId)).thenReturn(List.of());
        ...
        assertThat(result.getOverdueJobs().get(0).getTitle()).isEqualTo("Overdue Earlier");
    ...
    void get_shouldNotIncludeCompletedJobs_inOverdueList() {
        when(jobService.list(projectId, ownerId, null)).thenReturn(List.of(overdueButCompletedJob, overdueJobEarlier));
        when(projectMemberRepository.findByProjectIdAndUserId(projectId, ownerId))
                .thenReturn(Optional.of(ownerMembership));
        when(approvalService.listPendingByProject(projectId, ownerId)).thenReturn(List.of());
    ...
    void get_shouldIncludeBlockedJobs_inOverdueCount_whenPastDeadline() {
        ...
        when(jobService.list(projectId, ownerId, null)).thenReturn(List.of(blockedAndOverdue));
        when(projectMemberRepository.findByProjectIdAndUserId(projectId, ownerId))
                .thenReturn(Optional.of(ownerMembership));
        when(approvalService.listPendingByProject(projectId, ownerId)).thenReturn(List.of());
    ...
    void get_shouldReturnPendingApprovals_whenCallerIsOwner() {
        ...
        when(jobService.list(projectId, ownerId, null)).thenReturn(List.of());
        when(projectMemberRepository.findByProjectIdAndUserId(projectId, ownerId))
                .thenReturn(Optional.of(ownerMembership));
        ...
        assertThat(result.getPendingApprovals().get(0).getDescription()).isEqualTo("Need budget approval");
    ...
    void get_shouldReturnEmptyPendingApprovals_whenCallerIsMember() {
        when(jobService.list(projectId, memberId, null)).thenReturn(List.of(newJob));
        ...
        assertThat(result.getSummary().getPendingApprovalsCount()).isEqualTo(0);
    ...
    void get_shouldNotIncludeJobsWithNullDeadline_inOverdueList() {
        ...
        when(jobService.list(projectId, ownerId, null)).thenReturn(List.of(noDeadline));
        when(projectMemberRepository.findByProjectIdAndUserId(projectId, ownerId))
                .thenReturn(Optional.of(ownerMembership));
        when(approvalService.listPendingByProject(projectId, ownerId)).thenReturn(List.of());
        ...
        assertThat(result.getSummary().getOverdueCount()).isEqualTo(0);
    }
    ...
    void get_shouldNotIncludeJobsWithFutureDeadline_inOverdueList() {
        ...
        when(jobService.list(projectId, ownerId, null)).thenReturn(List.of(futureDeadline));
        when(projectMemberRepository.findByProjectIdAndUserId(projectId, ownerId))
                .thenReturn(Optional.of(ownerMembership));
        when(approvalService.listPendingByProject(projectId, ownerId)).thenReturn(List.of());
    ...
    void get_shouldIncludeNewJob_inOverdueList_whenPastDeadline() {
        ...
        when(jobService.list(projectId, ownerId, null)).thenReturn(List.of(overdueNew));
        when(projectMemberRepository.findByProjectIdAndUserId(projectId, ownerId))
                .thenReturn(Optional.of(ownerMembership));
        when(approvalService.listPendingByProject(projectId, ownerId)).thenReturn(List.of());
        ...
        assertThat(result.getOverdueJobs()).hasSize(1);
        assertThat(result.getOverdueJobs().get(0).getTitle()).isEqualTo("Overdue New Job");
        assertThat(result.getSummary().getOverdueCount()).isEqualTo(1);
    }
    ...
    void get_shouldReturnEmptyDashboard_whenProjectHasNoJobs() {
        ...
        assertThat(result.getSummary().getTotal()).isEqualTo(0);
