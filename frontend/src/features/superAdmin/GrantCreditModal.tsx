...
// Mirrors the backend floor (GrantCreditRequest.amount @Min) — avoids granting a
// credit too small to be worth the Paddle sync overhead (JOB-180).
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className="w-full rounded-lg border border-gray-300 dark:border-gray-600 px-3 py-2 text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:border-transparent"
          />
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">{t('superAdmin:grantModal.amountHint')}</p>
        </div>
