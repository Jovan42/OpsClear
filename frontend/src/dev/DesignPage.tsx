  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-10">
      <div className="mb-10">
        ...
        <p className="text-sm text-gray-500 mt-1">Component gallery for OpsClear UI review.</p>
      </div>
      ...
      <Section title="Colour palette">
        <div className="space-y-6">
          <div>
            <p className="text-xs text-gray-400 mb-3">Brand tokens</p>
          ...
          <div>
            <p className="text-xs text-gray-400 mb-3">Job status</p>
            <div className="flex flex-wrap gap-4">
          ...
          <div>
            <p className="text-xs text-gray-400 mb-3">Grays</p>
            <div className="flex flex-wrap gap-4">
      ...
      <Section title="Typography — Inter">
        <div className="space-y-3">
          <p className="text-2xl font-semibold text-gray-900">Heading 1 — 2xl / semibold</p>
          <p className="text-xl font-semibold text-gray-900">Heading 2 — xl / semibold</p>
          <p className="text-base font-medium text-gray-900">Heading 3 — base / medium</p>
          <p className="text-sm text-gray-700">Body — sm / regular — The quick brown fox jumps over the lazy dog.</p>
          <p className="text-sm text-gray-500">Body muted — sm / regular / gray-500</p>
          <p className="text-xs text-gray-400">Caption — xs / regular / gray-400</p>
          <p className="text-xs font-mono text-gray-500">Mono — xs / mono — UUID: 3f2d1a...</p>
        </div>
      </Section>
      ...
      <Section title="Buttons">
        <div className="space-y-4">
          <div>
            <p className="text-xs text-gray-400 mb-2">Variants — md</p>
      ...
      <Section title="Badges">
        <div className="space-y-4">
          <div>
            <p className="text-xs text-gray-400 mb-2">Job status</p>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {roles.map((role) => (
                <span
                  key={role}
                  className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium ${roleStyle[role]}`}
                >
      ...
      <Section title="Form elements">
        <div className="max-w-sm space-y-4">
          <div>
            <label htmlFor="input-default" className="block text-sm font-medium text-gray-700 mb-1">
              Input — default
            </label>
            <input
              id="input-default"
          ...
          <div>
            ...
            <input
              id="input-error"
              className="w-full rounded-lg border border-red-400 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-400 focus:border-transparent"
              placeholder="Invalid value"
            />
            <p className="mt-1 text-xs text-red-600">This field is required</p>
          </div>
          <div>
            <label htmlFor="textarea-default" className="block text-sm font-medium text-gray-700 mb-1">
              Textarea
            </label>
            <textarea
              id="textarea-default"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-xl">
          <div className="bg-white border border-gray-200 rounded-xl p-5 hover:border-gray-300 hover:shadow-sm transition-all">
            <div className="flex items-start justify-between gap-2 mb-2">
              <h3 className="font-semibold text-gray-900 text-sm">Website Redesign</h3>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-5 hover:border-gray-300 hover:shadow-sm transition-all">
            <div className="flex items-start justify-between gap-2 mb-2">
              <h3 className="font-semibold text-gray-900 text-sm">Office Relocation</h3>
            </div>
